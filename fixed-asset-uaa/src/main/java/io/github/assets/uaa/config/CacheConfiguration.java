package io.github.assets.uaa.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("fixedAssetsUaa");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("fixedAssetsUaa");
        ...
        config.getMapConfigs().put("io.github.assets.uaa.domain.*", initializeDomainMapConfig(jHipsterProperties));
