...
describe('Service Tests', () => {
  describe('FixedAssetInvoice Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a FixedAssetInvoice', () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            invoiceDate: currentDate.format(DATE_FORMAT)
      ...
      it('should update a FixedAssetInvoice', () => {
        const returnedFromService = Object.assign(
          {
      ...
      it('should return a list of FixedAssetInvoice', () => {
        const returnedFromService = Object.assign(
          {
            invoiceReference: 'BBBBBB',
            invoiceDate: currentDate.format(DATE_FORMAT),
      ...
      it('should delete a FixedAssetInvoice', () => {
