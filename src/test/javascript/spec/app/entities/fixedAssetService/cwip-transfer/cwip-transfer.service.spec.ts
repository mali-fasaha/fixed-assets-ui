...
import { CwipTransferService } from 'app/entities/fixedAssetService/cwip-transfer/cwip-transfer.service';
import { ICwipTransfer, CwipTransfer } from 'app/shared/model/fixedAssetService/cwip-transfer.model';
...
describe('Service Tests', () => {
  describe('CwipTransfer Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a CwipTransfer', () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            transferMonth: currentDate.format(DATE_FORMAT)
      ...
      it('should update a CwipTransfer', () => {
        const returnedFromService = Object.assign(
          {
            transferMonth: currentDate.format(DATE_FORMAT),
      ...
      it('should return a list of CwipTransfer', () => {
        const returnedFromService = Object.assign(
          {
            transferMonth: currentDate.format(DATE_FORMAT),
            assetSerialTag: 'BBBBBB',
      ...
      it('should delete a CwipTransfer', () => {
