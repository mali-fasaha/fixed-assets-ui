...
import { AssetTransactionService } from 'app/entities/fixedAssetService/asset-transaction/asset-transaction.service';
...
describe('Service Tests', () => {
  describe('AssetTransaction Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a AssetTransaction', () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            transactionDate: currentDate.format(DATE_FORMAT)
      ...
      it('should update a AssetTransaction', () => {
        const returnedFromService = Object.assign(
          {
      ...
      it('should return a list of AssetTransaction', () => {
        const returnedFromService = Object.assign(
          {
            transactionReference: 'BBBBBB',
            transactionDate: currentDate.format(DATE_FORMAT),
      ...
      it('should delete a AssetTransaction', () => {
