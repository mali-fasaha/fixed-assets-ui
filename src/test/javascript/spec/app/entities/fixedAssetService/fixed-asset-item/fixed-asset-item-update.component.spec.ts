...
import { FixedAssetItemUpdateComponent } from 'app/entities/fixedAssetService/fixed-asset-item/fixed-asset-item-update.component';
import { FixedAssetItemService } from 'app/entities/fixedAssetService/fixed-asset-item/fixed-asset-item.service';
import { FixedAssetItem } from 'app/shared/model/fixedAssetService/fixed-asset-item.model';
