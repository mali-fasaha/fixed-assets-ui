...
describe('Service Tests', () => {
  describe('CapitalWorkInProgress Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a CapitalWorkInProgress', () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            transactionMonth: currentDate.format(DATE_FORMAT)
      ...
      it('should update a CapitalWorkInProgress', () => {
        const returnedFromService = Object.assign(
          {
            transactionMonth: currentDate.format(DATE_FORMAT),
      ...
      it('should return a list of CapitalWorkInProgress', () => {
        const returnedFromService = Object.assign(
          {
            transactionMonth: currentDate.format(DATE_FORMAT),
            assetSerialTag: 'BBBBBB',
      ...
      it('should delete a CapitalWorkInProgress', () => {
