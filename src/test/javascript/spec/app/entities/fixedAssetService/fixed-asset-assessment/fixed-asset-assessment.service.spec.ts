...
import { FixedAssetAssessmentService } from 'app/entities/fixedAssetService/fixed-asset-assessment/fixed-asset-assessment.service';
import { IFixedAssetAssessment, FixedAssetAssessment } from 'app/shared/model/fixedAssetService/fixed-asset-assessment.model';
...
describe('Service Tests', () => {
  describe('FixedAssetAssessment Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a FixedAssetAssessment', () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            assessmentDate: currentDate.format(DATE_FORMAT),
      ...
      it('should update a FixedAssetAssessment', () => {
        const returnedFromService = Object.assign(
          {
            description: 'BBBBBB',
      ...
      it('should return a list of FixedAssetAssessment', () => {
        const returnedFromService = Object.assign(
          {
            description: 'BBBBBB',
            assetCondition: 'BBBBBB',
      ...
      it('should delete a FixedAssetAssessment', () => {
