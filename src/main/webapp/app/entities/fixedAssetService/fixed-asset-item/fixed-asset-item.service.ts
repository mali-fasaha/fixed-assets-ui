...
import { IFixedAssetItem } from 'app/shared/model/fixedAssetService/fixed-asset-item.model';
...
export class FixedAssetItemService {
  public resourceUrl = SERVER_API_URL + 'services/fixedassetservice/api/fixed-asset-items';
  public resourceSearchUrl = SERVER_API_URL + 'services/fixedassetservice/api/_search/fixed-asset-items';
