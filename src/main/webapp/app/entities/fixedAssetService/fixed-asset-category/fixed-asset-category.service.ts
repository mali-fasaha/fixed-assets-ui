...
import { IFixedAssetCategory } from 'app/shared/model/fixedAssetService/fixed-asset-category.model';
...
export class FixedAssetCategoryService {
  public resourceUrl = SERVER_API_URL + 'services/fixedassetservice/api/fixed-asset-categories';
  public resourceSearchUrl = SERVER_API_URL + 'services/fixedassetservice/api/_search/fixed-asset-categories';
