...
import { ICwipTransfer } from 'app/shared/model/fixedAssetService/cwip-transfer.model';
...
export class CwipTransferService {
  public resourceUrl = SERVER_API_URL + 'services/fixedassetservice/api/cwip-transfers';
  public resourceSearchUrl = SERVER_API_URL + 'services/fixedassetservice/api/_search/cwip-transfers';
