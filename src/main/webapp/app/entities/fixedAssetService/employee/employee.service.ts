...
import { IEmployee } from 'app/shared/model/fixedAssetService/employee.model';
...
export class EmployeeService {
  public resourceUrl = SERVER_API_URL + 'services/fixedassetservice/api/employees';
  public resourceSearchUrl = SERVER_API_URL + 'services/fixedassetservice/api/_search/employees';
