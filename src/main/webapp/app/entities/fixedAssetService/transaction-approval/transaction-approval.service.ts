...
import { ITransactionApproval } from 'app/shared/model/fixedAssetService/transaction-approval.model';
...
export class TransactionApprovalService {
  public resourceUrl = SERVER_API_URL + 'services/fixedassetservice/api/transaction-approvals';
  public resourceSearchUrl = SERVER_API_URL + 'services/fixedassetservice/api/_search/transaction-approvals';
