...
import { ICapitalWorkInProgress } from 'app/shared/model/fixedAssetService/capital-work-in-progress.model';
...
export class CapitalWorkInProgressService {
  public resourceUrl = SERVER_API_URL + 'services/fixedassetservice/api/capital-work-in-progresses';
  public resourceSearchUrl = SERVER_API_URL + 'services/fixedassetservice/api/_search/capital-work-in-progresses';
