...
import { IScannedDocument } from 'app/shared/model/fixedAssetService/scanned-document.model';
...
export class ScannedDocumentService {
  public resourceUrl = SERVER_API_URL + 'services/fixedassetservice/api/scanned-documents';
  public resourceSearchUrl = SERVER_API_URL + 'services/fixedassetservice/api/_search/scanned-documents';
