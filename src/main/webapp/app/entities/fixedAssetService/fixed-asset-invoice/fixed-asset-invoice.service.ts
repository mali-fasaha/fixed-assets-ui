...
export class FixedAssetInvoiceService {
  public resourceUrl = SERVER_API_URL + 'services/fixedassetservice/api/fixed-asset-invoices';
  public resourceSearchUrl = SERVER_API_URL + 'services/fixedassetservice/api/_search/fixed-asset-invoices';
