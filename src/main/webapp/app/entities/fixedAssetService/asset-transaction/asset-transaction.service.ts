...
export class AssetTransactionService {
  public resourceUrl = SERVER_API_URL + 'services/fixedassetservice/api/asset-transactions';
  public resourceSearchUrl = SERVER_API_URL + 'services/fixedassetservice/api/_search/asset-transactions';
