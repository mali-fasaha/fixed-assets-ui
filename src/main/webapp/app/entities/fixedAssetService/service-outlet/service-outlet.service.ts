...
import { IServiceOutlet } from 'app/shared/model/fixedAssetService/service-outlet.model';
...
export class ServiceOutletService {
  public resourceUrl = SERVER_API_URL + 'services/fixedassetservice/api/service-outlets';
  public resourceSearchUrl = SERVER_API_URL + 'services/fixedassetservice/api/_search/service-outlets';
