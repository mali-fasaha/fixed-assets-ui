...
import { IDepreciationRegime } from 'app/shared/model/fixedAssetService/depreciation-regime.model';
...
export class DepreciationRegimeService {
  public resourceUrl = SERVER_API_URL + 'services/fixedassetservice/api/depreciation-regimes';
  public resourceSearchUrl = SERVER_API_URL + 'services/fixedassetservice/api/_search/depreciation-regimes';
