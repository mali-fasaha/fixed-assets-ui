...
export class FileTypeService {
  public resourceUrl = SERVER_API_URL + 'services/fixedassetservice/api/file-types';
  public resourceSearchUrl = SERVER_API_URL + 'services/fixedassetservice/api/_search/file-types';
