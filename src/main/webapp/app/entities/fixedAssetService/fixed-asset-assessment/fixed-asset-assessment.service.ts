...
import { IFixedAssetAssessment } from 'app/shared/model/fixedAssetService/fixed-asset-assessment.model';
...
export class FixedAssetAssessmentService {
  public resourceUrl = SERVER_API_URL + 'services/fixedassetservice/api/fixed-asset-assessments';
  public resourceSearchUrl = SERVER_API_URL + 'services/fixedassetservice/api/_search/fixed-asset-assessments';
