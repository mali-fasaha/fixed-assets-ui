...
import { AssetAcquisitionService } from 'app/entities/fixedAssetService/asset-acquisition/asset-acquisition.service';
import { IAssetAcquisition, AssetAcquisition } from 'app/shared/model/fixedAssetService/asset-acquisition.model';
...
describe('Service Tests', () => {
  describe('AssetAcquisition Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a AssetAcquisition', () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            acquisitionMonth: currentDate.format(DATE_FORMAT)
      ...
      it('should update a AssetAcquisition', () => {
        const returnedFromService = Object.assign(
          {
            description: 'BBBBBB',
            acquisitionMonth: currentDate.format(DATE_FORMAT),
      ...
      it('should return a list of AssetAcquisition', () => {
        const returnedFromService = Object.assign(
          {
            description: 'BBBBBB',
            acquisitionMonth: currentDate.format(DATE_FORMAT),
      ...
      it('should delete a AssetAcquisition', () => {
