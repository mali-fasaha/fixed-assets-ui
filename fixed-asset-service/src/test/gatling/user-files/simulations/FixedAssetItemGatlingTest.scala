...
class FixedAssetItemGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the FixedAssetItem entity")
        ...
        .repeat(2) {
            ...
            .get("/services/fixedassets/api/fixed-asset-items")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new fixedAssetItem")
            .post("/services/fixedassets/api/fixed-asset-items")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/fixedassets${new_fixedAssetItem_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created fixedAssetItem")
            .delete("/services/fixedassets${new_fixedAssetItem_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
