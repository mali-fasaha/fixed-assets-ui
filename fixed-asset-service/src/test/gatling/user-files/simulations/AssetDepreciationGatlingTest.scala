...
class AssetDepreciationGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the AssetDepreciation entity")
        ...
        .repeat(2) {
            ...
            .get("/services/fixedassets/api/asset-depreciations")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new assetDepreciation")
            .post("/services/fixedassets/api/asset-depreciations")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/fixedassets${new_assetDepreciation_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created assetDepreciation")
            .delete("/services/fixedassets${new_assetDepreciation_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
