...
class ServiceOutletGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the ServiceOutlet entity")
        ...
        .repeat(2) {
            ...
            .get("/services/fixedassets/api/service-outlets")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new serviceOutlet")
            .post("/services/fixedassets/api/service-outlets")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/fixedassets${new_serviceOutlet_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created serviceOutlet")
            .delete("/services/fixedassets${new_serviceOutlet_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
