...
class AssetTransactionGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the AssetTransaction entity")
        ...
        .repeat(2) {
            ...
            .get("/services/fixedassets/api/asset-transactions")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new assetTransaction")
            .post("/services/fixedassets/api/asset-transactions")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/fixedassets${new_assetTransaction_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created assetTransaction")
            .delete("/services/fixedassets${new_assetTransaction_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
