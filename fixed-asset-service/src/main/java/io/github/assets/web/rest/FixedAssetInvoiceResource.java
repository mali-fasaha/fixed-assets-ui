...
public class FixedAssetInvoiceResource {
    ...
    private static final String ENTITY_NAME = "fixedAssetServiceFixedAssetInvoice";
    ...
    public ResponseEntity<List<FixedAssetInvoiceDTO>> getAllFixedAssetInvoices(FixedAssetInvoiceCriteria criteria, Pageable pageable) {
