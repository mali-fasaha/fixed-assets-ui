...
public class FixedAssetAssessmentResource {
    ...
    public ResponseEntity<List<FixedAssetAssessmentDTO>> getAllFixedAssetAssessments(FixedAssetAssessmentCriteria criteria, Pageable pageable) {
    ...
    */
    ...
    public ResponseEntity<List<FixedAssetAssessmentDTO>> searchFixedAssetAssessments(@RequestParam String query, Pageable pageable) {
