...
public class AssetAcquisitionResource {
    ...
    private static final String ENTITY_NAME = "fixedAssetsAssetAcquisition";
    ...
    public ResponseEntity<List<AssetAcquisitionDTO>> getAllAssetAcquisitions(AssetAcquisitionCriteria criteria, Pageable pageable) {
    ...
    */
    ...
    public ResponseEntity<List<AssetAcquisitionDTO>> searchAssetAcquisitions(@RequestParam String query, Pageable pageable) {
